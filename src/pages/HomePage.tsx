        ...
        <div className="flex items-center justify-center divide-x divide-primary-foreground/20">
          <div className="flex items-center gap-3 px-6 py-3">
            <div className="flex items-center gap-3">
              <a href="https://chat.whatsapp.com/DwcENVtty2fE9pMzYBeVG7" target="_blank" rel="noopener" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors" aria-label="WhatsApp">
              ...
              <a href="https://www.tiktok.com/@nahdamoskeeweert?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors" aria-label="TikTok">
