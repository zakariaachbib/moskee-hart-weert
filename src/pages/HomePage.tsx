      ...
      <div className="bg-gradient-gold">
        <div className="flex items-center justify-center divide-x divide-primary-foreground/20">
          <div className="flex items-center gap-4 px-6 py-3">
              <a href="https://chat.whatsapp.com/DwcENVtty2fE9pMzYBeVG7" target="_blank" rel="noopener" className="text-[#128C7E] drop-shadow-sm hover:scale-110 transition-transform" aria-label="WhatsApp">
              ...
              <a href="https://www.instagram.com/nahdamoskeeweert?igsh=MXN3d3hobTBkZmtsZA%3D%3D&utm_source=qr" target="_blank" rel="noopener" className="text-[#C13584] drop-shadow-sm hover:scale-110 transition-transform" aria-label="Instagram">
                <Instagram size={20} />
              </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="flex items-center gap-2 px-6 py-3 text-[#D32F2F] hover:text-[#B71C1C] text-sm font-semibold transition-colors"
          >
