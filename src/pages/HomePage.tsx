    ...
    <>
      ...
      <div className="bg-gradient-gold">
        <div className="flex items-center justify-center divide-x divide-primary-foreground/20">
          ...
          <a href="https://maps.app.goo.gl/MrFHWeRKss4kN3rH8" target="_blank" rel="noopener" className="flex items-center gap-2 px-6 py-3 text-primary-foreground/70 hover:text-primary-foreground text-sm font-medium transition-colors">
