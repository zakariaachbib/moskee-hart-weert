      ...
      <div className="bg-gradient-gold">
        <div className="flex items-center justify-center divide-x divide-primary-foreground/20">
          <div className="flex items-center gap-4 px-6 py-3">
            <span className="text-primary-foreground font-semibold text-sm tracking-wide uppercase">Volg ons</span>
            <div className="flex items-center gap-3">
              ...
              <a href="https://instagram.com/" target="_blank" rel="noopener" className="text-primary-foreground/60 hover:text-primary-foreground transition-colors" aria-label="Instagram">
                <Instagram size={18} />
              </a>
