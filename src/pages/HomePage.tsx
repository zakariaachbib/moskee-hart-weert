...
export default function HomePage() {
  return (
    <>
      ...
      {/* Socials - mobile only */}
      <section className="py-10 bg-brown sm:hidden">
        <div className="container text-center">
          <h3 className="font-heading text-2xl text-cream mb-6">Volg ons</h3>
          <div className="flex justify-center gap-6">
            <a href="https://wa.me/" target="_blank" rel="noopener" className="flex flex-col items-center gap-2 text-cream/70 hover:text-green-400 transition-colors">
            ...
            <a href="https://instagram.com/" target="_blank" rel="noopener" className="flex flex-col items-center gap-2 text-cream/70 hover:text-pink-400 transition-colors">
              <Instagram size={28} />
              <span className="text-xs">Instagram</span>
            </a>
            <a href="https://tiktok.com/" target="_blank" rel="noopener" className="flex flex-col items-center gap-2 text-cream/70 hover:text-cream transition-colors">
