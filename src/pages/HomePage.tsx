...
export default function HomePage() {
  return (
    <>
      ...
      {/* Socials bar */}
      <div className="bg-gradient-gold py-3">
        <div className="flex justify-center items-center gap-5">
          <span className="text-primary-foreground font-semibold text-sm">Volg ons</span>
          <div className="flex items-center gap-4">
            <a href="https://wa.me/" target="_blank" rel="noopener" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors" aria-label="WhatsApp">
            ...
            <a href="https://instagram.com/" target="_blank" rel="noopener" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors" aria-label="Instagram">
              <Instagram size={20} />
            </a>
            <a href="https://tiktok.com/" target="_blank" rel="noopener" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors" aria-label="TikTok">
