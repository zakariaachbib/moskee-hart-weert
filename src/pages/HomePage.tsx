        ...
        <div className="flex items-center justify-center divide-x divide-primary-foreground/20">
          <div className="flex items-center gap-3 px-6 py-3">
            <div className="flex items-center gap-3">
              <a href="https://chat.whatsapp.com/DwcENVtty2fE9pMzYBeVG7" target="_blank" rel="noopener" className="text-[#25D366] hover:opacity-80 transition-opacity" aria-label="WhatsApp">
              ...
              <a href="https://www.instagram.com/nahdamoskeeweert?igsh=MXN3d3hobTBkZmtsZA%3D%3D&utm_source=qr" target="_blank" rel="noopener" className="text-[#E4405F] hover:opacity-80 transition-opacity" aria-label="Instagram">
                <Instagram size={18} />
              </a>
              <a href="https://www.tiktok.com/@nahdamoskeeweert?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener" className="text-black hover:opacity-80 transition-opacity" aria-label="TikTok">
