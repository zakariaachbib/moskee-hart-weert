    ...
    <section className="min-h-[80vh] flex items-center justify-center islamic-pattern">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-2xl text-foreground">Admin Portaal</h1>
          <p className="text-muted-foreground text-sm mt-1">Log in om het dashboard te openen</p>
        </div>
