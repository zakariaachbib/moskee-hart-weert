      ...
      <section className="container max-w-4xl -mt-6 mb-4 relative z-10">
        <div className="grid grid-cols-2 gap-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="overflow-hidden rounded-2xl">
            <img src={zaalVerhuur1} alt="Zaal 1" className="w-full h-48 sm:h-64 object-cover hover:scale-105 transition-transform duration-500" />
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="overflow-hidden rounded-2xl">
            <img src={zaalVerhuur2} alt="Zaal 2" className="w-full h-48 sm:h-64 object-cover hover:scale-105 transition-transform duration-500" />
          </motion.div>
        </div>
      </section>
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                      {bookingMode === "internal" ? (
                        <>
                          <li>{`Duur: ${INTERNAL_DURATION_OPTIONS.find(o => o.value === internalDuration)?.label || `${internalDuration} min`}`}</li>
                          <li>Interne reservering — direct goedgekeurd</li>
                        </>
                      ) : (
                        <>
                          <li>Muziek is niet toegestaan</li>
                          <li>Onderwijs en lezingen zijn niet toegestaan</li>
                          <li>De externe huurperiode duurt minimaal 8 uur</li>
