    ...
    <>
      ...
      <section className="relative bg-brown overflow-hidden min-h-[350px] md:min-h-[400px]">
        <div className="absolute inset-0">
          <img src={imamPreekHero} alt="Imam Dr. Ayoub ben Aicha tijdens de khutba" className="w-full h-full object-cover object-[center_20%] opacity-60 md:object-contain md:object-top" />
