...
import BeheerderAgenda from "./pages/beheerder/BeheerderAgenda";
      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/cursussen/videos" element={<AdminCursusVideos />} />
            ...
            <Route path="/beheerder/agenda" element={<BeheerderAgenda />} />
