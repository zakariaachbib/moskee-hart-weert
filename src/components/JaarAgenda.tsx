          ...
          <div className="bg-muted/40 rounded-xl border border-border p-4">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                <span className="text-primary font-heading text-lg font-bold">A</span>
              </div>
              <div>
                <p className="text-sm font-semibold text-foreground">Aziz Hanzaz</p>
                <p className="text-xs text-muted-foreground">Coördinator Onderwijs</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              >
                ...
                <span>WhatsApp — +31 6 43138435</span>
              </a>
              <a
