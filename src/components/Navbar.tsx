    ...
    <nav className="sticky top-0 z-50 bg-brown/95 backdrop-blur-md shadow-lg">
      <div className="container flex items-center justify-between py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/doneren"
            className="bg-gradient-gold text-primary-foreground px-5 py-2 rounded-full text-sm font-semibold hover:brightness-110 transition-all shadow-[0_2px_12px_rgba(212,175,55,0.3)] hover:shadow-[0_4px_20px_rgba(212,175,55,0.45)] hover:scale-105"
          >
            {t.nav.donate}
          </Link>
