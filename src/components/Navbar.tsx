      ...
      <div className="container flex items-center justify-between py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <a href="https://wa.me/" target="_blank" rel="noopener" className="text-cream/60 hover:text-green-400 transition-colors" aria-label="WhatsApp">
            ...
            <a href="https://instagram.com/" target="_blank" rel="noopener" className="text-cream/60 hover:text-pink-400 transition-colors" aria-label="Instagram">
              <Instagram size={18} />
            </a>
            <a href="https://tiktok.com/" target="_blank" rel="noopener" className="text-cream/60 hover:text-cream transition-colors" aria-label="TikTok">
